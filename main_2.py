...
async def chat_websocket(websocket: WebSocket, sender_id: str):
    ...
    try:
        while True:
            ...
            message_format = receiverSettings.get("message_format", "Text")
            receiver_lang = receiverSettings.get("receiver_lang", "None")
            ...
            if receiver_lang == "None" and (
                ...
                if receiver_lang and (
                    ...
                    trans_meadia_url = await text_to_audios(msg_text, receiver_lang)
                else:
                    trans_message = msg_text
